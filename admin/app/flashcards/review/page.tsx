...
export default function FlashcardsReviewPage() {
  ...
  const [visualRequiredFilter, setVisualRequiredFilter] =
    useState<string>("all");
  ...
  const loadFlashcards = async () => {
    ...
    try {
      ...
      if (visualRequiredFilter !== "all")
        params.append("visualRequirement", visualRequiredFilter);
    ...
    <div className="p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Review and approve pending flashcards ({totalCount} total, showing{" "}
          {flashcards.length} on page {currentPage})
        </p>
      </div>
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-blue-900 font-medium">
                    Select All ({flashcards.length} flashcard
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {imageAssets.map((asset) => (
                    <div
                      ...
                      onClick={() => handleBindAsset(showAssetPicker, asset.id)}
                    >
